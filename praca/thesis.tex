  ...
  \section{Description of tools}
    ...
    \subsection{Java}
      ...
      \subsubsection{Alternative}
        C\# is also an object--oriented programming language, but it is used to develop software for Microsoft platforms\ksremark{spacja przed cytowaniem}\cite{bib:thai2003net}.
