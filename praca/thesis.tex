...
\label{chap:req&tools}
  ...
  \section{Nonfunctional requirements}
    ...
    \begin{itemize}
      ...
      \item The application should hash all sensitive data stored in a database. %TODO
...
\chapter{External specification}
  \section{Types of users and cockpits}
    ...
    \end{itemize}
    Each cockpit requires specific user role to access it's website.
  ...
  \section{Installation procedure}
    ...
    In order to build project, you have to execute Maven install lifecycle \lstinline[language=bash]|mvn install| in APP\_ROOT directory.
  ...
  \section{Activation procedure}
    ...
    Same behaviour with default admin user with password 'nimda'---it is in the database on first startup.
    ...
    That's the procedure you should follow when you want to add administrator to the system.
    After that you should delete predefined admin user from table user, with following query:
...
\chapter{Verification and validation}
  ...
  \section{Test cases}
    ...
    \subsection{Sending ward protocol test}
      ...
      This scenario is tested %TODO (doesn't work):and application displays appropriate messages to user.
...
\chapter{Conclusions}
  ...
  Almost all of the functional and nonfunctional requirements are met using tools described in that chapter.%TODO: change to all after implementation of everything
