...
\chapter{External specification}
  ...
  \section{Activation procedure}
    ...
    Same behaviour with the default admin user with password 'nimda' \ksremark{`nimda'}---it is in the database on the first startup.
  ...
  \section{User manual}
    \subsection{Voter manual}
      ...
      Second one \ksremark{Może: \emph{Second type}?} is a preference voting, in which voter can mark candidates by his choice of preference:
