...
\chapter{Conclusions}
  Objective of the thesis was to create an voting system in accordance with the requirements stated in \autoref{chap:req&tools}. \ksremark{Tu trzeba napisać trochę więcej o systemie. Tak żeby wyszedł jeden akapit o cechach aplikacji.}
